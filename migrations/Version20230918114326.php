 ...
 */
final class Version20230918114326 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operation (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, prix INT NOT NULL, etat VARCHAR(100) NOT NULL, date_realisation DATE NOT NULL, INDEX IDX_1981A66D19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
